...
#if (SYSTEM_IMPLEMENTATION == SYSTEM_IMPLEMENTATION_EMBEDDED_ARDUINO)
        Serial.println("EKF: bCalcJacobianF failed");
#endif
        return false;
    }
...
#if (SYSTEM_IMPLEMENTATION == SYSTEM_IMPLEMENTATION_EMBEDDED_ARDUINO)
        Serial.println("EKF: bNonlinearUpdateX failed");
#endif
        return false;
    }
...
#if (SYSTEM_IMPLEMENTATION == SYSTEM_IMPLEMENTATION_EMBEDDED_ARDUINO)
        Serial.println("EKF: bCalcJacobianH failed");
#endif
        return false;
    }
...
#if (SYSTEM_IMPLEMENTATION == SYSTEM_IMPLEMENTATION_EMBEDDED_ARDUINO)
        Serial.println("EKF: Gain invalid (possibly singular S)");
#endif
        return false;
    }
...
#if (SYSTEM_IMPLEMENTATION == SYSTEM_IMPLEMENTATION_EMBEDDED_ARDUINO)
        Serial.println("EKF: bNonlinearUpdateY failed");
#endif
        return false;
    }
